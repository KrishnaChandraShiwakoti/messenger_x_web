  ...
  return (
    <div className="w-full max-w-md">
      ...
      <form
        ...
        <div className="mb-5">
          <label className="mb-2 block text-xs font-bold uppercase tracking-[1.5px] text-body">
            Email
          </label>
          <input
            type="email"
          ...
          />
          {errors.email && (
            <span className="mt-1 block text-sm text-m-red">
        ...
        <p className="mt-6 text-center text-sm font-light text-body">
          ...
          <Link
            href="/register"
            className="font-bold text-on-dark underline-offset-4 hover:underline">
            Register here
          </Link>
          .
        </p>
